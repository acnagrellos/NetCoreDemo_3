...
namespace Customers.Api.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        private readonly ICustomerLogService _customersLogService;

        public CustomersController(ICustomersService customersService, ICustomerLogService customersLogService)
        {
            _customersService = customersService;
            _customersLogService = customersLogService;
        }
        ...
        [HttpGet($"{ApiConstants.Logs}/{ApiConstants.CustomerParamId}", Name = nameof(CustomersController.GetCustomersLog))]
        [ProducesResponseType(typeof(IEnumerable<CustomerResponse>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<int>> GetCustomersLog([FromRoute] int customerId)
        {
            var result = _customersLogService.GetCustomerAccessLog(customerId);
            return Ok(result);
        }
    }
}
